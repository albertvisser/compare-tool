...
def test_refresh_htmlcompare(monkeypatch, capsys):
    ...
    assert capsys.readouterr().out == textwrap.dedent("""\
            ...
            called ComparerGui.colorize_header with args ("child for '<head>'", False, False, True)
            ...
            called ComparerGui.colorize_header with args ("child for '<body>'", True, False, False)
            """)
